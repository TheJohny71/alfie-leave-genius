    ...
    <div className="min-h-screen flex flex-col items-center relative z-10">
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full px-4 mt-8">
          <div className="glass p-10 text-center animate-float group hover:bg-white/[0.12] transition-all duration-500">
          ...
          <div className="glass p-10 text-center animate-float [animation-delay:200ms] group hover:bg-white/[0.12] transition-all duration-500">
          ...
          <div className="glass p-10 text-center animate-float [animation-delay:400ms] group hover:bg-white/[0.12] transition-all duration-500">
